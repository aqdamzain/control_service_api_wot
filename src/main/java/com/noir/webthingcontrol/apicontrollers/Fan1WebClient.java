...
@Component
public class Fan1WebClient {
    private final WebClient client;

    public Fan1WebClient(WebClient.Builder builder) {
        this.client = builder.baseUrl("http://192.168.1.202:80").build();
    }

    public Mono<WebThing> getThingDevice() {
        return this
                .client.get().uri("/things/fan-1").accept(MediaType.APPLICATION_JSON)
                .retrieve()
    ...
    public Mono<OnProperty> getPropertyOn() {
        return this
                .client.get().uri("/things/fan-1/properties/on").accept(MediaType.APPLICATION_JSON)
                .retrieve()
    ...
    public Mono<OnProperty> updatePropertyOn(OnProperty onProperty) {
        return this
                .client.put().uri("/things/fan-1/properties/on")
